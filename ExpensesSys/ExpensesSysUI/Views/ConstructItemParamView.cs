...
{
    public class ConstructItemParamView:BaseEntity
    {
        private string budgetName;
        private string topConstructName;
        private string secondaryConstructName;
        private string constructItemName;
        ...
        public string ConstructItemName
        {
            get { return constructItemName; }
            set { constructItemName = value;RaisePropertyChanged(); }
        }
